...
add_filter( 'woocommerce_enqueue_styles', 'miller_body_woocommerce_styles' );
/**
 ...
 */
function miller_body_woocommerce_styles( $enqueue_styles ) {
...
add_action( 'wp_enqueue_scripts', 'miller_body_woocommerce_css' );
/**
 ...
 */
function miller_body_woocommerce_css() {
	...
	$color_link   = get_theme_mod( 'miller_body_link_color', $appearance['default-colors']['link'] );
	$color_accent = get_theme_mod( 'miller_body_accent_color', $appearance['default-colors']['accent'] );
	...
	',
		$color_accent,
		miller_body_color_contrast( $color_accent )
	) : '';
