...
$miller_body_shared_content = genesis_get_config( 'onboarding-shared' );

return [
	'starter_packs' => [
		'black-white' => [
			'title'       => __( 'Black & White', 'miller-body' ),
			'description' => __( 'A pack with a homepage designed with black and white images.', 'miller-body' ),
			...
			'config'      => [
				'dependencies'     => [
					'plugins' => $miller_body_shared_content['plugins'],
				],
				'content'          => array_merge(
					[
						'homepage' => [
					...
					$miller_body_shared_content['content']
				),
				'navigation_menus' => $miller_body_shared_content['navigation_menus'],
				'widgets'          => $miller_body_shared_content['widgets'],
			],
		],
		'color'       => [
			'title'       => __( 'Color', 'miller-body' ),
			'description' => __( 'A pack with a homepage designed with color images.', 'miller-body' ),
